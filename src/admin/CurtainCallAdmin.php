...
namespace CurtainCallWP\admin;

use CurtainCallWP\includes\CurtainCallHelpers as Helpers;
use CurtainCallWP\includes\CurtainCallHelperFunctions;
use Carbon\Carbon;
 ...
 *  @subpackage CurtainCallWP/admin
**/
    ...
    **/
    public function enqueue_styles() 
    {
        ...
        **/
        ...
        wp_enqueue_style($this->plugin_name . '_datepicker', plugin_dir_url( __FILE__ ) . 'js/ccwp_datepicker/jquery-ui.css', array(), $this->version, 'all');

        wp_enqueue_style($this->plugin_name . '_general', plugin_dir_url( __FILE__ ) . 'css/curtian-call-wp-admin.css', array(), $this->version, 'all');        
    }
    ...
    **/
    public function enqueue_scripts() 
    {
        ...
        **/
        ...
        wp_enqueue_script($this->plugin_name . '_datepicker', plugin_dir_url(__FILE__) . 'js/ccwp_datepicker/jquery-ui.min.js', array('jquery'), $this->version, true);
        
        wp_enqueue_script($this->plugin_name . '_general', plugin_dir_url(__FILE__) . 'js/curtian-call-wp-admin.js', array('jquery', $this->plugin_name . '_datepicker'), $this->version, true);
    ...
    public function ccwp_set_post_type_title_on_post_submit( $data ) 
    {
    ...
    **/
    ...
    { ?>
        ...
        <?php 
            ...
            $prod_date_start = Carbon::parse(get_post_meta($post->ID, '_ccwp_production_date_start', true))->format('m/d/Y');
        ...
        <div class="ccwp-form-group">
            ...
            <input type="text" class="ccwp_datepicker_input" id="ccwp_date_start" name="ccwp_date_start" value="<?php echo $prod_date_start ?>">
        </div>
        <div class="ccwp-form-group">
            <label for="ccwp_date_end"><strong>Production Dates - Closed*</strong></label>
            <input type="text" class="ccwp_datepicker_input" id="ccwp_date_end" name="ccwp_date_end" value="<?php echo $prod_date_end; ?>">
        </div>
        ...
        <div id ="ccwp-production-cast-wrap">
            <?php if (!empty($cast_members) && is_array($cast_members)): ?>
                ...
                <?php foreach($cast_members as $cast_member): ?>
                    <tr class="form-group ccwp-production-castcrew-form-group" id="ccwp-production-cast-member-<?php echo $cast_member['ID']; ?>">
                        <input type="hidden" name="ccwp_add_cast_to_production[<?php echo $cast_member['ID']; ?>][cast_and_crew_id]" value="<?php echo $cast_member['ID']; ?>">
                        <input type="hidden" name="ccwp_add_cast_to_production[<?php echo $cast_member['ID']; ?>][production_id]" value="<?php echo $post->ID; ?>">
                        <input type="hidden" name="ccwp_add_cast_to_production[<?php echo $cast_member['ID']; ?>][type]" value="cast">
                        <td class="ccwp-castcrew-name"><?php echo $cast_member['post_title']; ?></td>
                        <td><input type="text" name="ccwp_add_cast_to_production[<?php echo $cast_member['ID']; ?>][role]" placeholder="role" value="<?php echo $cast_member['ccwp_role']; ?>"></td>
                        <td><input type="text" name="ccwp_add_cast_to_production[<?php echo $cast_member['ID']; ?>][custom_order]" placeholder="custom order" value="<?php echo $cast_member['ccwp_custom_order']; ?>"></td>
                        <td><button type="button" class="ccwp-remove-castcrew-from-production" data-target="ccwp-production-cast-member-<?php echo $cast_member['ID']; ?>">Delete</button></td>
                    </tr>
                <?php endforeach; ?>
                </table>
            <?php endif; ?>
        ...
        <div id="ccwp-production-crew-wrap">
            <?php if (!empty($crew_members) && is_array($crew_members)): ?>
                ...
                <?php foreach($crew_members as $crew_member): ?>
                    <tr class="form-group ccwp-production-castcrew-form-group" id="ccwp-production-crew-member-<?php echo $crew_member['ID']; ?>">
                        <input type="hidden" name="ccwp_add_crew_to_production[<?php echo $crew_member['ID']; ?>][cast_and_crew_id]" value="<?php echo $crew_member['ID']; ?>">
                        <input type="hidden" name="ccwp_add_crew_to_production[<?php echo $crew_member['ID']; ?>][production_id]" value="<?php echo $post->ID; ?>">
                        <input type="hidden" name="ccwp_add_crew_to_production[<?php echo $crew_member['ID']; ?>][type]" value="crew">
                        <td class="ccwp-castcrew-name"><?php echo $crew_member['post_title']; ?></td>
                        <td><input type="text" name="ccwp_add_crew_to_production[<?php echo $crew_member['ID']; ?>][role]" placeholder="role" value="<?php echo $crew_member['ccwp_role']; ?>"></td>
                        <td><input type="text" name="ccwp_add_crew_to_production[<?php echo $crew_member['ID']; ?>][custom_order]" placeholder="custom order" value="<?php echo $crew_member['ccwp_custom_order']; ?>"></td>
                        <td><button type="button" class="ccwp-remove-castcrew-from-production" data-target="ccwp-production-crew-member-<?php echo $crew_member['ID']; ?>">Delete</button></td>
                    </tr>
                <?php endforeach; ?>
                </table>
            <?php endif; ?>
    ...
    **/
    ...
    { ?>
        ...
        <?php 
            ...
            $cast_crew_birthday = Carbon::parse(get_post_meta($post->ID, '_ccwp_cast_crew_birthday', true))->format('m/d/Y');
        ...
        <div class="ccwp-form-group">
            ...
            <input type="name_last" id="ccwp_name_last" name="ccwp_name_last" value="<?php echo $cast_crew_name_last ?>">
        </div>
        <div class="ccwp-form-help-text">
        ...
        <div class="ccwp-form-group">
            ...
            <input type="self_title" id="ccwp_self_title" name="ccwp_self_title" value="<?php echo $cast_crew_self_title ?>">
        </div>
        <div class="ccwp-form-help-text">
            <p>*Required. If the cast or crew member has many roles across different productions, try to use the one they identify with the most. Ex. Director, Actor, Choreographer, etc.</p>
        </div>
        
        <div class="ccwp-form-group">
            <label for="ccwp_birthday">Birthday</label>
            <input type="text" class="ccwp_datepicker_input" id="ccwp_birthday" name="ccwp_birthday" value="<?php echo $cast_crew_birthday; ?>">
        </div>
        <div class="ccwp-form-help-text">
        ...
        <div class="ccwp-form-group">
            ...
            <input type="text" id="ccwp_website_link" name="ccwp_website_link" value="<?php echo $cast_crew_website_link; ?>">
        </div>
        
        <div class="ccwp-form-group">
            <label for="ccwp_facebook_link">Facebook Link</label>
            <input type="text" id="ccwp_facebook_link" name="ccwp_facebook_link" value="<?php echo $cast_crew_facebook_link; ?>">
        </div>
        
        <div class="ccwp-form-group">
            <label for="ccwp_twitter_link">Twitter Link</label>
            <input type="text" id="ccwp_twitter_link" name="ccwp_twitter_link" value="<?php echo $cast_crew_twitter_link; ?>">
        </div>
        
        <div class="ccwp-form-group">
            <label for="ccwp_instagram_link">Instagram Link</label>
            <input type="text" id="ccwp_instagram_link" name="ccwp_instagram_link" value="<?php echo $cast_crew_instagram_link; ?>">
        </div>
