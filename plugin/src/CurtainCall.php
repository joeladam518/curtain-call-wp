...
class CurtainCall
{
    ...
    protected function defineAdminHooks()
    {
        ...
        $this->loader->add_action('add_meta_boxes', $plugin_admin, 'add_custom_meta_boxes_for_production_post_type', 10,
            3);
        $this->loader->add_action('save_post_ccwp_production', $plugin_admin, 'ccwp_production_details_save', 10, 2);
        $this->loader->add_action('save_post_ccwp_production', $plugin_admin,
            'ccwp_add_cast_and_crew_to_production_save', 10, 2);
        ...
        $this->loader->add_action('add_meta_boxes', $plugin_admin, 'add_custom_meta_box_for_cast_and_crew_post_type',
            10, 3);
        $this->loader->add_action('save_post_ccwp_cast_and_crew', $plugin_admin, 'ccwp_cast_and_crew_details_save', 10,
            2);
        
        // All Actions and Filters that concern both post types
        $this->loader->add_filter('wp_insert_post_data', $plugin_admin, 'ccwp_set_post_type_title_on_post_submit', 99,
            1);
